...
// code ported from webGPU samples camera
export const init/* : SampleInit */ = async ({ canvas/*, pageState, gui */ }) => {
  // if (!pageState.active) {
  //   return;
  // }
  ...
  {
    const response = await fetch('/img/texture.png');
